...
Most prose **lives in the [zeroclaw](https://github.com/morpheum-labs/zeroclaw) repository** under `docs/`. Edit there first, then refresh this site with the sync script (or open a PR that runs the sync after upstream merges).

## Change content

1. Clone [morpheum-labs/zeroclaw](https://github.com/morpheum-labs/zeroclaw) and edit files under `docs/` following that repo’s guidelines.
