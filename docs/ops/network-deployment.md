...
- [channels-reference.md](/docs/reference/api/channels-reference) — Channel configuration overview
- [matrix-e2ee-guide.md](/docs/security/matrix-e2ee-guide) — Matrix setup and encrypted-room troubleshooting
- [hardware-peripherals-design.md](/docs/hardware/hardware-peripherals-design) — Peripherals design
- [adding-boards-and-tools.md](/docs/contributing/adding-boards-and-tools) — Hardware setup and adding boards
