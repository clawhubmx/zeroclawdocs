...
For first-time installation, start from [one-click-bootstrap.md](/docs/setup-guides/one-click-bootstrap).
...
For full setup instructions, see [one-click-bootstrap.md](/docs/setup-guides/one-click-bootstrap#stopping-and-restarting-a-dockerpodman-container).
...
- [one-click-bootstrap.md](/docs/setup-guides/one-click-bootstrap)
- [troubleshooting.md](/docs/ops/troubleshooting)
- [config-reference.md](/docs/reference/api/config-reference)
- [commands-reference.md](/docs/reference/cli/commands-reference)
