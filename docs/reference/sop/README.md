...
- **Connect Events:** [Connectivity & Fan-In](/docs/reference/sop/connectivity) — trigger SOPs via MQTT, webhooks, cron, or peripherals.
- **Write SOPs:** [Syntax Reference](/docs/reference/sop/syntax) — required file layout and trigger/step syntax.
- **Monitor:** [Observability & Audit](/docs/reference/sop/observability) — where run state and audit entries are stored.
- **Examples:** [Cookbook](/docs/reference/sop/cookbook) — reusable SOP patterns.
...
For trigger routing and auth details, see [Connectivity](/docs/reference/sop/connectivity).
