...
See detailed channel matrix and allowlist behavior in [channels-reference.md](/docs/reference/api/channels-reference).
...
- See [channels-reference.md](/docs/reference/api/channels-reference) for full config examples.
...
- See [nextcloud-talk-setup.md](/docs/setup-guides/nextcloud-talk-setup) for setup and troubleshooting.
...
- See [hardware-peripherals-design.md](/docs/hardware/hardware-peripherals-design) for protocol details.
...
- See [hardware-peripherals-design.md](/docs/hardware/hardware-peripherals-design) for board protocol and firmware notes.
...
- [channels-reference.md](/docs/reference/api/channels-reference)
- [providers-reference.md](/docs/reference/api/providers-reference)
- [operations-runbook.md](/docs/ops/operations-runbook)
- [troubleshooting.md](/docs/ops/troubleshooting)
