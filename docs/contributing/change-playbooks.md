...
For complete code examples of each extension trait, see [extension-examples.md](/docs/contributing/extension-examples).
...
- See [ADR-004: Tool Shared State Ownership](/docs/architecture/adr-004-tool-shared-state-ownership) for the full contract.
