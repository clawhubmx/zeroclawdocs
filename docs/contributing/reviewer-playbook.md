...
This playbook is the operational companion to [`pr-workflow.md`](/docs/contributing/pr-workflow).
For broader documentation navigation, use [`docs/README.md`](/docs/hub).
...
- [pr-workflow.md](/docs/contributing/pr-workflow) — governance workflow and merge contract.
- [ci-map.md](/docs/contributing/ci-map) — CI ownership and triage map.
