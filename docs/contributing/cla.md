...
- **"ZeroClaw Labs"** means the maintainers and organization responsible
  for the ZeroClaw project at https://github.com/morpheum-labs/zeroclaw.
...
trademarks, service marks, or logos. See [trademark.md](/docs/maintainers/trademark) for trademark policy.
...
https://github.com/morpheum-labs/zeroclaw/issues
