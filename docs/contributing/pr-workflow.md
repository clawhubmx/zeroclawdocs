...
- [`docs/README.md`](/docs/hub) for documentation taxonomy and navigation.
- [`ci-map.md`](/docs/contributing/ci-map) for per-workflow ownership, triggers, and triage flow.
- [`reviewer-playbook.md`](/docs/contributing/reviewer-playbook) for day-to-day reviewer execution.
...
- [README.md](/docs/hub) — documentation taxonomy and navigation.
- [ci-map.md](/docs/contributing/ci-map) — CI workflow ownership and triage map.
- [reviewer-playbook.md](/docs/contributing/reviewer-playbook) — reviewer execution model.
- [actions-source-policy.md](/docs/contributing/actions-source-policy) — action source allowlist policy.
