...
For event-by-event delivery behavior across PR, merge, push, and release, see [`.github/workflows/master-branch-flow.md`](https://github.com/morpheum-labs/zeroclaw/blob/master/.github/workflows/master-branch-flow.md) in the repository.
...
- Follow [`docs/contributing/release-process.md`](/docs/contributing/release-process) for verify-before-publish release cadence and tag discipline.
...
- Keep Actions source policy restricted to approved allowlist patterns (see [`docs/contributing/actions-source-policy.md`](/docs/contributing/actions-source-policy)).
