...
For step-by-step integration checklists, see [change-playbooks.md](/docs/contributing/change-playbooks).
...
See [change-playbooks.md](/docs/contributing/change-playbooks) for full checklists per extension type.
